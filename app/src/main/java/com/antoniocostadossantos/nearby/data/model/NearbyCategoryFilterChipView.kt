package com.antoniocostadossantos.nearby.data.model
...
enum class NearbyCategoryFilterChipView(
    ...
    FARMACIA(description = "Alimentação", icon = R.drawable.ic_first_aid_kit),
    COMBUSTIVEL(description = "Alimentação", icon = R.drawable.ic_gas_station),
    PADARIA(description = "Padaria", icon = R.drawable.ic_bakery);

    companion object {
        fun fromDescription(description: String) = entries.find { it.description == description }
    }
}
